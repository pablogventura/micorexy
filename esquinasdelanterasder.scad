...
module tornillo(){
rotate([90,0,0]){
cylinder(r1=8/2,r2=4/2,h=5);
cylinder(r=4/2,h=50);
translate([0,0,-9.5-40])cylinder(r=8/2,h=50);
}
}
difference(){
mirror([1,0,0])
...
union(){
hull(){
translate([15.5,-10,-10])cube([9,10,50]);
translate([-17.5,-10,18])cube([24.5,10,18]);

}
translate([15.5,-10,14])cube([9,10,16]);
translate([15.5,-10,14+5-9])cube([9,52,16-2+9+5]);
translate([-17.5,-10,33.2+2.5])cube([42,52,5]);
}
...
hull(){
translate([-3.5,21.5,20-6.2+13.5+6/3+5])color("red")cylinder(d=23,h=20,center=true);
